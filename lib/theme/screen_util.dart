...
class CustomTextStyles {
  ...
  static get mulishBold16 => theme.textTheme.labelLarge!.copyWith(
    color: Color(0xffB4BDC4),
    fontSize: 16
  );
  static get jostMedium18 => theme.textTheme.titleMedium!.copyWith(
      color: Colors.black,
      fontSize: 18
  );
  static get mulishBold15 => theme.textTheme.labelLarge!.copyWith(
      color: Color(0xffB4BDC4),
      fontWeight: FontWeight.bold,
      fontSize: 15
  );
  static get mulishExtraBold15 => theme.textTheme.labelLarge!.copyWith(
      color: Color(0xffB4BDC4),
      fontWeight: FontWeight.bold,
      fontSize: 15
  );
  static get mulishExtraBold11=> theme.textTheme.labelLarge!.copyWith(
      color: Colors.black,
      fontWeight: FontWeight.bold,
      fontSize: 11
  );
  static get mulishExtraBold15Blue => theme.textTheme.labelLarge!.copyWith(
      color: appTheme.blueA700,
      fontWeight: FontWeight.bold,
      fontSize: 15
  );
  static get mulishExtraBold14 => theme.textTheme.labelLarge!.copyWith(
      fontWeight: FontWeight.bold,
      fontSize: 14
  );
